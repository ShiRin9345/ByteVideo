    ...
    var i = (function () {
      ...
      p = (function () {
        function e(t) {
          ...
          (h.default.os.ipad
            ? (l = "pad")
            : (h.default.os.iphone || h.default.os.android) && (l = "phone"),
            ...
            [
              {
                ...
                value: function (e, t) {
                  ...
                  var i = [];
                  for (var r in this.initParam)
                    i.push(r + "=" + this.initParam[r]);
                  var a = i.join("&");
                  if (AliyunUpload && AliyunUpload.__logTestCallback__)
                    AliyunUpload.__logTestCallback__(a);
                  else {
                    new Image(0, 0).src =
                      "https://videocloud.cn-hangzhou.log.aliyuncs.com/logstores/upload/track?" +
                      a;
                  }
                },
              },
            ...
            [
              {
                ...
                value: function () {
                  ...
                  return (
                    e ||
                      ((e = s.default.create()),
                      c.default.set("p_h5_upload_u", e, 730)),
                    e
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    e || (e = s.default.create()),
                    c.default.set("p_h5_upload_clientId", e, 730),
                    e
                  );
                },
              },
    ...
    var o = (function () {
      ...
      a = function () {
        ...
        return (
          (e.indexOf("Windows NT 5.0") > -1 ||
            ...
            (t = "2000"),
          (e.indexOf("Windows NT 5.1") > -1 || e.indexOf("Windows XP") > -1) &&
            (t = "XP"),
          ...
          (e.indexOf("Windows NT 6.2") > -1 || e.indexOf("Windows 8") > -1) &&
            (t = "8"),
          (e.indexOf("Windows NT 6.3") > -1 || e.indexOf("Windows 8.1") > -1) &&
            (t = "8.1"),
          (e.indexOf("Windows NT 10") > -1 || e.indexOf("Windows 10") > -1) &&
            (t = "10"),
          t
        );
      },
      ...
      u = (function () {
        ...
        if (
          ...
          d &&
            !f &&
            ((e.ios = e.iphone = !0), (e.version = d[2].replace(/_/g, "."))),
          l && ((e.ios = e.ipad = !0), (e.version = l[2].replace(/_/g, "."))),
          f &&
            ((e.ios = e.ipod = !0),
            (e.version = f[3] ? f[3].replace(/_/g, ".") : null)),
          ...
          U &&
            (c || e.ios || p || u) &&
            ((t.safari = !0), e.ios || (t.version = U[1])),
          k && (t.webview = !0),
          c)
        ) {
            ...
            o(e, null, [
              ...
              },
              {
                ...
                value: function (t, n, r) {
                  if (!t)
                    throw new Error(
                      "PrismPlayer Error: vid should not be null!",
                    );
                  var o = [];
                  for (var i in t) o.push(i);
                  for (
                    var a = o.sort(), s = "", u = a.length, i = 0;
                    i < u;
                    i++
                  ) {
          ...
          function e(t) {
            (o(this, e),
              ...
              (this.options.partSize =
                this.options.partSize || s.UPLOADDEFAULT.PARTSIZE),
              (this.options.parallel =
                this.options.parallel || s.UPLOADDEFAULT.PARALLEL),
              (this.options.region = this.options.region || "cn-shanghai"),
              (this.options.cname = this.options.cname || !1),
              (this.options.localCheckpoint =
                this.options.localCheckpoint || !1),
              (this.options.enableUploadProgress =
                !1 !== this.options.enableUploadProgress),
            ...
            i(e, [
              ...
              },
              {
                ...
                value: function (e, t, n, r, o, i) {
                  ...
                  for (
                    var s = (this.options, 0);
                    s < this._uploadList.length;
                    s++
                  )
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  try {
                    this.options.addFileSuccess &&
                      this.options.addFileSuccess(e);
                  } catch (e) {
                    console.log(e);
                  }
                  return !0;
              ...
              },
              {
                ...
                value: function (e) {
                  for (
                    var t = this.options, n = 0, r = 0;
                    r < this._uploadList.length;
                    r++
                  )
                    (t.uploadList[r].state == a.UPLOADSTATE.SUCCESS && n++,
                      this._uploadList[r].state == e &&
                        (t.uploadList.splice(r, 1), r--));
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  ...
                  (o.ImageType && (i.imageType = o.ImageType),
                    ...
                    o.TemplateGroupId &&
                      (i.templateGroupId = o.TemplateGroupId),
                    o.StorageLocation &&
                      (i.storageLocation = o.StorageLocation),
                    ...
                    T.default[u](
                      ...
                      function (t) {
                        ((e.videoId = t.VideoId ? t.VideoId : e.videoId),
                          e.isImage &&
                            ((e.videoId = t.ImageId ? t.ImageId : e.videoId),
                            (e.imageId = t.ImageId ? t.ImageId : e.imageId)),
                          s.setUploadAuthAndAddress(
                            e,
                            t.UploadAuth,
                            t.UploadAddress,
                          ),
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (
                    ...
                    0 != t.loaded &&
                      this._reportLog("20007", e, { pn: i, requestId: s }),
                    1 != t.loaded &&
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  n &&
                    (this._onbeforeunload && (t = a.UPLOADSTATE.STOPED),
              ...
              },
              {
                ...
                value: function () {
                  for (var e = 0; e < this._uploadList.length; e++) {
                    var t = this._uploadList[e];
                    (t.state != a.UPLOADSTATE.FAIlURE &&
                      t.state != a.UPLOADSTATE.STOPED) ||
            ...
            i(e, [
              {
                ...
                value: function (e) {
                  if (
                    ...
                    throw new Error(
                      "AccessKeyId、AccessKeySecret、endpoint should not be null",
                    );
                  var t = {
                  ...
                  var n = this,
                    ...
                    o = {
                      parallel:
                        ...
                        a.UPLOADDEFAULT.PARALLEL,
                      partSize: Math.round(
                        t.partSize ||
                          this._config.partSize ||
                          a.UPLOADDEFAULT.PARTSIZE,
                      ),
                      progress: r,
                    };
  ...
  function (e, t, n) {
    ...
    function a(e) {
      ...
      for (n = 0; n < l; n += 4)
        ((t =
          (f[e.charCodeAt(n)] << 18) |
          (f[e.charCodeAt(n + 1)] << 12) |
          (f[e.charCodeAt(n + 2)] << 6) |
          f[e.charCodeAt(n + 3)]),
          (u[c++] = (t >> 16) & 255),
          (u[c++] = (t >> 8) & 255),
          (u[c++] = 255 & t));
      return (
        2 === s &&
          ((t = (f[e.charCodeAt(n)] << 2) | (f[e.charCodeAt(n + 1)] >> 4)),
          (u[c++] = 255 & t)),
        1 === s &&
          ((t =
            (f[e.charCodeAt(n)] << 10) |
            (f[e.charCodeAt(n + 1)] << 4) |
            (f[e.charCodeAt(n + 2)] >> 2)),
          (u[c++] = (t >> 8) & 255),
          (u[c++] = 255 & t)),
        u
      );
    ...
    function c(e) {
      for (
        ...
        o.push(u(e, i, i + 16383 > a ? a : i + 16383));
      return (
        1 === r
              ...
              value: function (e, t, n) {
                var r = (c.default.randomUUID(), c.default.randomUUID()),
                  ...
                  i =
                    ...
                    "&Signature=" +
                    c.default.aliyunEncodeURI(
                      c.default.makeChangeSiga(o, e.accessKeySecret),
                    ),
          ...
          i(e, null, [
            {
              ...
              value: function (e, t, n) {
                ...
                return (
                  t && (r = e + "|" + t + "|f#Ylm&^1TppeRhLg|" + n),
                  _(w.parse(r)).toString(m)
                );
              },
            },
            {
              ...
              value: function (t, n, r) {
                ...
                var u = e.getAuthInfo(t.userId, a, i),
                  ...
                  d = {
                    ...
                    TerminalType: "H5",
                    DeviceModel:
                      c.default.browser.name +
                      (c.default.browser.version || ""),
                ...
                a && (d.ClientId = a);
                var p =
                    y.default.makeUTF8sort(d, "=", "&") +
                    "&Signature=" +
                    y.default.aliyunEncodeURI(
                      y.default.makeChangeSiga(d, t.accessKeySecret),
                    ),
                  ...
                  function (e) {
                    ...
                    ((e = e ? JSON.parse(e) : {}),
                      e.UploadProgress &&
                        ...
                        ((t = e.UploadProgress.UploadProgressList[0]),
                        (r = t.ClientId)),
